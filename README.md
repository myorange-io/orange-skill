...
- **연결** — Next.js 앱을 만들어 GitHub·Vercel·Supabase에 CLI로 한 번에 연결. 라이브 URL 확보.
- **구현** — 화면을 하나씩 진짜로 만듭니다. 푸시할 때마다 자동 배포·자동 저장됩니다.
...
Claude: [Next.js 스캐폴드 → GitHub·Vercel·Supabase 연결]
        ✅ 앱이 인터넷에 떴습니다: https://....vercel.app
        [화면을 하나씩 구현 — 만들 때마다 git push → 자동 배포]
        ✅ 완성 — 공유 가능한 URL을 받으세요.
```
